...
## Contributors and Author redesign
...
Spotifly credits to
[Musify](https://github.com/Harsh-23/Musify) - Original inspiration . It is now completely reimplemented with new design and branding.
...
```
Copyright © 2026 Layla Mansur by original Valeri Gokadze

Spotifly is free software licensed under GPL v3.0. You may use, modify, and distribute
...
```
Spotifly and its contributors do not host, own, or distribute any copyrighted audio content.
...
The developers of Spotifly do not encourage or endorse copyright infringement and assume no liability for misuse of the software or third-party plugins.
```
---
Rules Brazil Guideliness
